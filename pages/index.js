    ...
    <div className="px-10 flex flex-wrap rounded-lg overflow-hidden">
      ...
      <div className="lg:w-1/2 w-full lg:py-6 lg:pl-5">
        <div className="sm:flex rounded-lg p-5 bg-neutral-800 mb-10 sm:mb-5">
          <Image
            src="https://creatornode.audius6.prod-us-west-2.staked.cloud/content/QmUVXGpoXMdi2oNbdph6RVyBvxdBHRsAGA888WvRh7yE1m/150x150.jpg"
            alt="Week 29 of 2013"
            width={100}
            height={100}
            priority
          ...
          <div className="w-full flex flex-col justify-center">
            ...
            >
              <source
                src="https://creatornode.audius6.prod-us-west-2.staked.cloud/tracks/stream/EaXJR"
                type="audio/mpeg"
              />
            </audio>
          </div>
        ...
        <div className="sm:flex rounded-lg p-5 bg-neutral-800 mb-10 sm:mb-5">
          <Image
            src="https://creatornode.audius6.prod-us-west-2.staked.cloud/content/QmTWQcVofczZCeJvcUXHaMHhNhzXsFq2DQQexjnDzLAb4e/150x150.jpg"
            alt="Week 30 of 2012"
            width={100}
            height={100}
            priority
          ...
          <div className="w-full flex flex-col justify-center">
            ...
            >
              <source
                src="https://creatornode.audius6.prod-us-west-2.staked.cloud/tracks/stream/JNb8Z"
                type="audio/mpeg"
              />
            </audio>
          </div>
        ...
        <div className="sm:flex rounded-lg p-5 bg-neutral-800">
          <Image
            src="https://creatornode.audius6.prod-us-west-2.staked.cloud/content/QmVJxxLbGHvu7SD12fxbuqmvTJi1zk294fFVSYRksK9Dg4/150x150.jpg"
            alt="Week 37 of 2011"
            width={100}
            height={100}
            priority
          ...
          <div className="w-full flex flex-col justify-center">
            ...
            >
              <source
                src="https://creatornode.audius6.prod-us-west-2.staked.cloud/tracks/stream/0R7PK"
                type="audio/mpeg"
              />
            </audio>
          </div>
